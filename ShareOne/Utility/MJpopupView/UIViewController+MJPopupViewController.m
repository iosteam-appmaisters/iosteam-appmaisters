...
-(void)setLayouConstriant:(UIView *)centerView
{
    
    UIView *subView=centerView;
    UIView *parent=[self topView];
...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType dismissed:(void(^)(void))dismissed
{
    ...
    UIImageView *imgview=[[UIImageView alloc] initWithFrame:sourceView.bounds];
    [imgview setImage:[UIImage imageNamed:@"black_transparent"]];
    ...
    //[self setLayouConstriant:overlayView];
